...
void Dio_SetGroupDirection (u8 GroupNo, u8 Direction)
{
		if(GroupNo<=GroupD)
		{
			if(Direction == OUTPUT)
			{
				switch(GroupNo)
				{
				case GroupA: SET_BIT(DDRA, All_PIN); break;
				case GroupB: SET_BIT(DDRB, All_PIN); break;
				case GroupC: SET_BIT(DDRC, All_PIN); break;
				case GroupD: SET_BIT(DDRD, All_PIN); break;
				}
			}
			else if(Direction == INPUT)
			{
				switch(GroupNo)
				{
				case GroupA: CLR_BIT(DDRA, All_PIN); break;
				case GroupB: CLR_BIT(DDRB, All_PIN); break;
				case GroupC: CLR_BIT(DDRC, All_PIN); break;
				case GroupD: CLR_BIT(DDRD, All_PIN); break;
				}
			}
			else {
					// Wrong Direction Do-nothing
			}
